...
//connect to database
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($task)){
            ...
            mysqli_query($db, "INSERT INTO tasks (task, username, duedate) VALUES ('$task', '$username', '$due')");
...
<body>
    <div class="page-header">
        <h1>Hello, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to your To-Do List.</h1>
    </div>
    <p>
